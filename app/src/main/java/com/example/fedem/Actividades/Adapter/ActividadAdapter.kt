...
class ActividadAdapter(private var actividades: MutableList<ActividadEntity>, private var listener: OnClickListenerActividades):RecyclerView.Adapter<ActividadAdapter.ViewHolder>(){
